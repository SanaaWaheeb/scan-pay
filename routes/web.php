...
Route::get('user-cart-item/{slug?}/scanner/{product_id?}/{quantity?}/{variant_id?}', [StoreController::class, 'StoreScanner'])->name('store.scanner');


// The trsting route
Route::get('payment-checkout/{slug}/{order_amount}', [PaymentController::class, 'processCheckout'])->name(name: 'payment.checkout');
Route::get('payment-status/{slug}/{order_id}', [PaymentController::class, 'paymentStatus'])->name('payment.status');
