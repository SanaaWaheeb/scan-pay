...
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            {{ Form::label('max_stores', __('Maximum stores'), ['class' => 'col-form-label']) }}<x-required></x-required>
    ...
    <div class="col-6">
        <div class="form-group">
            {{ Form::label('max_products', __('Maximum Product Per Store'), ['class' => 'col-form-label']) }}<x-required></x-required>
    ...
    <div class="col-6">
        <div class="form-group">
            {{ Form::label('max_users', __('Maximum Users Per Store'), ['class' => 'col-form-label']) }}<x-required></x-required>
    ...
    <div class="col-md-12 {{ $plan['trial'] == 'on' ?'  ':'d-none' }} plan_div mt-2">
        <div class="form-group">
            {{ Form::label('trial_days', __('Trial Days'), ['class' => 'col-form-label']) }}<x-required></x-required>
