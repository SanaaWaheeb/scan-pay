                                        ...
                                        <tbody>
                                            @foreach($payRequests as $key => $transaction)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('amount.request',[$transaction->id,1])}}" class="btn bg-light-secondary btn-sm">
                                                            <i class="ti ti-check"></i>
                                                        </a>
                                                        <a href="{{route('amount.request',[$transaction->id,0])}}" class="btn bg-light-secondary btn-sm">
                                                        <i class="ti ti-x"></i>
                                                        </a>
                                                    </td>
                                                </tr>
