...
<div class="row">
    ...
    <div class="form-group form-footer col-12 d-flex justify-content-end col-form-label">
        <button type="button" class="btn-secondary btn btn-light" style="margin-left: 15px;" id="close" data-bs-dismiss="modal" aria-label="Close"><span aria-hidden ="true">{{__('Cancel')}}</span></button>
